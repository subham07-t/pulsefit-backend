/*
  ...
  - The `reps` column on the `CFMeasureMovement` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
-- AlterTable
ALTER TABLE `CFMeasureMovement` DROP COLUMN `reps`,
    ADD COLUMN `reps` JSON NULL;
